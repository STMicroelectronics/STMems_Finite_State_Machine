...
#ifndef LIS2DUXS12_MOTION_STATIONARY_H
#define LIS2DUXS12_MOTION_STATIONARY_H
...
static const ucf_line_ext_t lis2duxs12_motion_stationary[] = {
  ...
  { .op = MEMS_UCF_OP_WRITE, .address = 0x09, .data = 0x71 },
  { .op = MEMS_UCF_OP_WRITE, .address = 0x09, .data = 0x00 },
  ...
  { .op = MEMS_UCF_OP_WRITE, .address = 0x09, .data = 0x00 },
  { .op = MEMS_UCF_OP_WRITE, .address = 0x09, .data = 0x00 },
  { .op = MEMS_UCF_OP_WRITE, .address = 0x09, .data = 0x7D },
...
#endif /* LIS2DUXS12_MOTION_STATIONARY_H */
