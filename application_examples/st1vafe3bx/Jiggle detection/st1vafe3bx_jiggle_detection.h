...
#ifndef ST1VAFE3BX_JIGGLE_DETECTION_H
#define ST1VAFE3BX_JIGGLE_DETECTION_H
...
static const ucf_line_ext_t st1vafe3bx_jiggle_detection[] = {
  ...
  { .op = MEMS_UCF_OP_WRITE, .address = 0x09, .data = 0x5B },
  ...
  { .op = MEMS_UCF_OP_WRITE, .address = 0x14, .data = 0x63 },
  { .op = MEMS_UCF_OP_WRITE, .address = 0x13, .data = 0x10 },
  { .op = MEMS_UCF_OP_DELAY, .address = 0, .data = 5 },
  { .op = MEMS_UCF_OP_WRITE, .address = 0x14, .data = 0x00 },
  { .op = MEMS_UCF_OP_WRITE, .address = 0x3F, .data = 0x80 },
...
#endif /* ST1VAFE3BX_JIGGLE_DETECTION_H */
